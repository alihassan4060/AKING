#SOURCE LEAKED BY :MR-ALI
#REASON : BECAUSE I'M HARDWORKING 
#WAS INTERFERE BETWEEN
#ALI & KAMBOH 😎 
from os import path
import os,base64,zlib,pip,urllib
os.system('xdg-open https://www.facebook.com/groups/240688346345925/')
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://m.facebook.com/groups/240688346345925/permalink/1687125298368882/?mibextid=Nif5oz/?app=fbl');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+923085884060&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi MR-ALI Sir, I Need To Buy Your Paid AKING PRO Tools Version 1.9.8 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
